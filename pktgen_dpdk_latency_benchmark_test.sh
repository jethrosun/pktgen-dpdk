...
{
    touch /home/jethros/test/pktgen_latency.lua
    lua_file="/home/jethros/test/pktgen_latency.lua"
    chmod 777 $lua_file
    echo $lua_file

    cat << EOF > "/home/jethros/test/pktgen_latency.lua"
...
create_expect_file()
{
    touch /home/jethros/test/pktgen.exp
    expect_file="/home/jethros/test/pktgen.exp"
    chmod 777 $expect_file
    echo $expect_file

    cat << 'EOF' > "/home/jethros/test/pktgen.exp"
#!/usr/bin/expect
...
set result {}
set timeout 15
spawn ./app/x86_64-native-linuxapp-gcc/pktgen -l 0-4 -n 3 -b $blacklist -- -P -m "1.0, 2.0, 3.0, 2.1, 3.1, 4.1" -f /home/jethros/test/pktgen_latency.lua -s 0:large-traces/huge-trace-only-tcp.pcap
expect "Pktgen>"
send "\n"
expect "Pktgen>"
set count 10
...
run_pktgen()
{
    ...
    cd /home/jethros/dev/pktgen-dpdk
    touch /home/jethros/test/result.log
    result_log="/home/jethros/test/result.log"
    sudo expect /home/jethros/test/pktgen.exp $blacklist $result_log
}
